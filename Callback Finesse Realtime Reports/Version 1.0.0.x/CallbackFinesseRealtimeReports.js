...
function RefreshCallbackRealtimeData()
{
	...
	var url = sCallbackServer + '?operation=getrecords';
...
{
	clientLogs.log("CallbackFinesseRealtimeReports.handleResponseSuccess_GetRecords(): Enter");
...
function UpdateUI(records)
{
	...
	UpdateUIComponents(aValidatedRecords.length,OldestWaitingDuration,AvgWaitingDuration);
...
finesse.modules.CallbackFinesseRealtimeReports = (function ($) {
    ...
    return {
        ...
        init : function () {
			...
			sVersion = " [DEV Version: 1.0.0.0005]";
